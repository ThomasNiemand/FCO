...
model better than another?) are provided in an exploratory manner. Starting with version 2, we offer a lot improvements and additional new decision rules as well as many flexibility options. 
